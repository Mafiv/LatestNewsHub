import HeadNewsSlider from "./headNewsSlider";
...
export function Heading_news({ data }) {
  ...
  return (
    <div className="mt-8 lg:mb-8 lg:grid lg:grid-cols-2 lg:pb-2">
      <section className="lg: lg:flex lg:flex-col">
        <div
          className="relative lg:mx-auto lg:mb-5 lg:h-[360px] lg:w-[600px] lg:rounded-md lg:border lg:border-black lg:shadow-md lg:shadow-black/20"
          style={getBackgroundImageStyle(0, true)}
        >
          <div className="absolute bottom-0 h-auto w-full rounded-lg bg-gradient-to-t from-black to-transparent">
        ...
        <div className="mx-auto w-[95%] lg:grid lg:rounded-md lg:border ">
          <div className="lg:flex lg:justify-between lg:gap-4 lg:px-2">
            ...
            <div
              className="relative bg-cover lg:h-full lg:w-[55%]"
      ...
      <section className="relative">
        <div className="lg:mb-4 lg:grid lg:h-[250px] lg:w-full lg:grid-cols-[2fr_3fr] lg:bg-[#1A1A1A] lg:px-4 lg:pt-4 lg:text-white">
          ...
          >
            <div className="absolute bottom-0 h-auto w-full rounded-lg bg-gradient-to-t from-black to-transparent">
              <h3 className="font-Helvetica px-4 pt-10 text-center text-sm tracking-wide text-white">
                {headlines[2].title}
              </h3>
              <div className="flex-row-2 font-Helvetica my-4 ml-6 flex gap-4 text-sm text-[#908f8f]">
